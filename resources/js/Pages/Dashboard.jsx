            ...
            <div className="py-12">
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 gap-6 mt-6 sm:grid-cols-2">
                        <motion.div className="p-6 bg-white rounded-lg shadow-md dark:bg-gray-800 flex items-center space-x-4" variants={cardVariants} initial="hidden" animate="visible" transition={{ duration: 0.5, delay: 0.8 }}>
                            <FaClipboardList className="text-red-500 text-3xl" />
                            <div>
                                <h3 className="text-lg font-semibold text-gray-700 dark:text-gray-200">Tentatives</h3>
                                <p className="mt-2 text-2xl font-bold text-gray-900 dark:text-gray-100">{tentatives}</p>
                            </div>
                        </motion.div>
                        <motion.div className="p-6 bg-white rounded-lg shadow-md dark:bg-gray-800 flex items-center space-x-4" variants={cardVariants} initial="hidden" animate="visible" transition={{ duration: 0.5, delay: 1 }}>
                            <FaMedal className="text-yellow-500 text-3xl" />
                            <div>
                                <h3 className="text-lg font-semibold text-gray-700 dark:text-gray-200">Points Obtenus</h3>
                                <p className="mt-2 text-2xl font-bold text-gray-900 dark:text-gray-100">{pointsemis} / {totalpoints}</p>
                            </div>
                        </motion.div>
                    </div>
                    ...
                    <div className="mt-6">
                        <motion.div className="p-6 bg-white rounded-lg shadow-md dark:bg-gray-800" variants={cardVariants} initial="hidden" animate="visible" transition={{ duration: 0.5, delay: 1.2 }}>
                            <h3 className="text-lg font-semibold text-gray-700 dark:text-gray-200">Dernières Tentatives</h3>
                            <div className="mt-4 overflow-x-auto">
                                <table className="w-full table-auto border-gray-300 dark:border-gray-600">
                                    <thead>
                                        <tr className="bg-gray-100 dark:bg-gray-700">
