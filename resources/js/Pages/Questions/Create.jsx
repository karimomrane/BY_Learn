...
export default function Create() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route("questions.store", quizze.id));
    };

    return (
        <AuthenticatedLayout
            header={<h2 className="text-2xl font-bold text-gray-800 dark:text-gray-200">Create New Question</h2>}
        >
            <div className="py-12">
